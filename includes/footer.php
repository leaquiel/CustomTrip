<div class="footer-container"> <!--INICIO DEL CONTENEDOR DEL FOOTER-->

  <footer>

    <div class="footer-enlances">
  ...
  <div class="pie">
    ...
    <h1 class="main-footer-tittle">CostumTrip</h1> <!--TITULO DE footer PRINCIPAL-->
